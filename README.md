...
> **Язык проекта — русский.** Документация, вопросы к пользователю, план, цены и подписи
> на готовой странице — по-русски. Отвечать про этот проект тоже по-русски, если сам
