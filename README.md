# roomwalk — скролл-шапка для сайта

**Русскоязычный проект.** Вся документация, вопросы к пользователю, план, цены и подписи
на готовой странице — по-русски. Разговор об этом проекте тоже идёт по-русски, если сам
человек не пишет на другом языке.
